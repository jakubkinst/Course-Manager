<?php //netteCache[01]000341a:2:{s:4:"time";s:21:"0.39180200 1302022689";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:55:"C:\xampp\htdocs\rp\app\templates\Homepage\default.latte";i:2;i:1299799378;}i:1;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:10:"checkConst";}i:1;s:19:"Framework::REVISION";i:2;s:30:"7616569 released on 2011-03-10";}}}?><?php

// source file: C:\xampp\htdocs\rp\app\templates\Homepage\default.latte

?><?php
$_l = LatteMacros::initRuntime($template, NULL, '8p0m9t832q'); unset($_extends);


//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb81a4471e16_content')) { function _lb81a4471e16_content($_l, $_args) { extract($_args)
?>
<div id="wrapper">
	<div id="logo"></div>
	...
	<ol>
		...
		<p>Manage your database using pre-installed tool <a href="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/adminer/">Adminer</a> with an easy to use GUI.<p>
	...
	<h2>We hope you enjoy this framework! <img src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/images/nette-powered2.gif" width="80" height="15" alt="Nette Framework powered" /></h2>

	<ul id="environment">
		<li>PHP <?php echo TemplateHelpers::escapeHtml(PHP_VERSION) ?></li><?php if (isset($_SERVER['SERVER_SOFTWARE'])): ?>
		<li>Server <?php echo TemplateHelpers::escapeHtml($_SERVER['SERVER_SOFTWARE']) ?></li>
<?php endif ?>
		<li>Nette Framework <?php echo TemplateHelpers::escapeHtml(Framework::VERSION) ?></li>
	</ul>
</div>
<?php
}}
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb7310c2548c_head')) { function _lb7310c2548c_head($_l, $_args) { extract($_args)
?>
<style>
	html {
